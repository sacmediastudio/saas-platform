...
export const authTranslations = {
  en: {
    ...
    forgotPassword: {
      ...
      submit: "Send link",
      submitting: "Sending...",
      done: "If that email is registered, we sent a reset link to it.",
  ...
  es: {
    ...
    forgotPassword: {
      ...
      subtitle: "Escribe tu correo y te mandamos un link para cambiarla.",
      email: "name@correo.com",
      submit: "Mandar link",
      submitting: "Enviando...",
      done: "Si ese correo está registrado, te mandamos un link para cambiarla.",
    ...
    resetPassword: {
      ...
      invalidToken: "Este link no es válido o ya expiró.",
      requestNew: "Pedir un link nuevo",
    },
    signup: {
